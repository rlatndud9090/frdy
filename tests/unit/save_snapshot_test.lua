...
function suite.test_run_model_snapshots_restore_expected_progress()
  ...
  TestHelper.assert_true(fixture.reward_manager:_add_legendary_item('titan_heart'))
  TestHelper.assert_true(fixture.reward_manager:_add_legendary_item('gale_boots'))
  ...
  TestHelper.assert_equal(type(restored.spell_book:get_spell_by_id('time_warp'):get_effect().apply), 'function')
  TestHelper.assert_equal(restored.spell_book:get_spell_by_id('time_warp'):get_effect().status_id, 'speed_up_flat')
  TestHelper.assert_equal(restored.spell_book:get_spell_by_id('time_warp'):get_effect().status_spec.payload.speed_bonus, 3)
  ...
  TestHelper.assert_equal(restored.reward_manager:get_legendary_inventory():get_count(), 3)
  TestHelper.assert_true(restored.reward_manager:get_legendary_inventory():has_item('ember_crown'))
  TestHelper.assert_true(restored.reward_manager:get_legendary_inventory():has_item('titan_heart'))
  TestHelper.assert_true(restored.reward_manager:get_legendary_inventory():has_item('gale_boots'))
  ...
  TestHelper.assert_equal(restored.hero:get_max_hp(), fixture.hero:get_max_hp())
